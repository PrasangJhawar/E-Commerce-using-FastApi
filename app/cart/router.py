...
from app.auth.models import User                      # ✅ corrected
from app.products.models import Product               # ✅ corrected
from app.auth.dependencies import get_current_user           # ✅ corrected
